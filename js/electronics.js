/**
    -- Script For [electonics.html] Page
    -- Drawen Products In [parent_electronics_products] ID
    -- [232] Is The Starting Line For HTMl
    -- ==> Array Of Data At [dataPages.js] At Line [941]
 */
let parentElectronicsProducts = document.querySelector("#parent_electronics_products");

electronicProducts.map((ele) => {
    parentElectronicsProducts.innerHTML += `
